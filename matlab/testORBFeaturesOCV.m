...
% |estimateGeometricTransform2D| are used to find the rotation angle and
...
inlierDistorted = matchedDistorted(inlierIndex,:);
inlierOriginal = matchedOriginal(inlierIndex,:);
